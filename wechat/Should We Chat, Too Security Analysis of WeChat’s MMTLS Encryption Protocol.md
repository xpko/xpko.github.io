...
This report consists of a technical description of [how WeChat launches a network request](#launching-a-wechat-network-request) and its [encryption protocols](#wechat-network-request-encryption), followed by a [summary of weaknesses in WeChat’s protocol](#security-issues), and finally a [high-level discussion](#discussion) of WeChat’s design choices and their impact. The report is intended for privacy, security, or other technical researchers interested in furthering the privacy and security study of WeChat. For non-technical audiences, we have summarized our findings in this FAQ.
